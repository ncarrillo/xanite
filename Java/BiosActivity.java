...
public class BiosActivity extends AppCompatActivity {
    ...
    static {
        System.loadLibrary("bios_lib"); // تحميل مكتبة C++
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            if (isBiosLoaded && isBootRomLoaded && isHddImageLoaded) {
                ...
                Toast.makeText(BiosActivity.this, "Please add BIOS, Boot ROM, and Xbox HDD Image", Toast.LENGTH_LONG).show();
            }
        });
    }
                ...
                switch (requestCode) {
                    case PICK_BIOS_FILE_REQUEST:
                        if (BIOS_FILE_NAME.equals(fileName)) {
                            ...
                            if (success) {
                                ...
                                Toast.makeText(this, "BIOS loaded successfully!", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(this, "Failed to load BIOS!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                    ...
                    case PICK_BOOT_ROM_FILE_REQUEST:
                        if (BOOT_ROM_FILE_NAME.equals(fileName)) {
                            ...
                            Toast.makeText(this, "Boot ROM loaded successfully!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(this, "Invalid Boot ROM file!", Toast.LENGTH_LONG).show();
                        }
                        break;
                    ...
                    case PICK_HDD_IMAGE_FILE_REQUEST:
                        if (HDD_IMAGE_FILE_NAME.equals(fileName)) {
                            ...
                            Toast.makeText(this, "Xbox HDD Image loaded successfully!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(this, "Invalid Xbox HDD Image file!", Toast.LENGTH_LONG).show();
                        }
                        break;
